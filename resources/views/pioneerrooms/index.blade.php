...
<article class="post">
  <header>
    <div class="title">
      <h2><a href="single.html">Pioneers Wharf Room Finder</a></h2>
      <p>Total:  {{ $pioneerrooms->count() }} locations currently logged</p>
    </div>
    <div class="meta">
      ...
      <a href="#" class="author"><span class="name">
        @auth
          {{ Auth::user()->name }}
        @endauth
      </span><img src="/pioneerimg/main.JPG" alt="" /></a>
    </div>
  </header>
  <a href="/" class="image featured"><img src="/pioneerimg/main.JPG" alt="" /></a>
  <p>Welcome to the pioneer Wharf Group Room Finder</p>
